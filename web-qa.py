...
full_url = "https://pydriller.readthedocs.io/en/latest/"
...
def crawl(url):
    ...
    while queue:
        ...
        # Save text from the url to a <url>.txt file and handle this url for a filename 'text/pypi.org/pypi.org__search__?o=&q=streamlit%2A&page=1.txt
        filename = (
            url[8:]
            .replace("/", "_")
            .replace("?", "_")
...
def sanitize_filename(url):
    ...
    sanitized_url = re.sub(r'[^a-zA-Z0-9_-]', '', url)
    return sanitized_url

# Path to the SSL certificate file
ssl_cert_file = os.path.abspath('api.openai.com.cer')
print (ssl_cert_file)

# Set the SSL certificate file for requests library
os.environ['REQUESTS_CA_BUNDLE'] = ssl_cert_file
os.environ['CURL_CA_BUNDLE'] = ssl_cert_file
os.environ['OPENSSL_X509_CERT_FILE'] = ssl_cert_file
...
openai.api_key='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'
